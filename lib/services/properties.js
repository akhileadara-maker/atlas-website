...
// The agent's system prompt — re-injected into Retell on every KB save. Lives
// in lib/agentPrompt.mjs so scripts/sync-agent-prompts.mjs pushes the exact
// same text when backfilling all agents after a prompt rewrite.
